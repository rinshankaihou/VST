...
*)
  ...
  Proof.
    ...
    red; intros. destruct H; auto. generalize (typesize_pos ty); Lia.lia.
  Qed.
  ...
  - destruct (slot_eq sl sl0).
    ...
    left; auto.
    right; red; intros [P | [P | P]]. congruence. Lia.lia. Lia.lia.
    left; auto.
  Defined.
...
Module OrderedLoc <: OrderedType.
  ...
  Proof.
    ...
    destruct H. destruct H0. Lia.lia.
...
(** Connection between the ordering defined here and the [Loc.diff] predicate. *)
  ...
  Proof.
    ...
    - destruct (OrderedSlot.compare sl sl'); auto.
      ...
      destruct H.
      right; right; split; auto. left; Lia.lia.
