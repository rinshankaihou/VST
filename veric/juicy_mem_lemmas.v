...
Proof.
  ...
  iMod (mapsto_storebytes _ (b, ofs) _ (encode_val ch v') with "Hm H") as "[$ H]"; try done.
...
Proof.
  ...
  iMod (mapsto_store' with "[$]") as "($ & % & %Hv'' & H)"; try done.
...
Proof.
  intros.
  iIntros "Hm"; iMod (mapsto_alloc with "Hm") as "[$ H]"; try done.
...
Proof.
  ...
  iApply (mapsto_free with "Hm H"); try done.
