...
Proof.
  ...
  + iDestruct "H" as "[% H]"; iApply (nonlock_permission_bytes_valid_pointer1 with "H"); rewrite ?Ptrofs.unsigned_repr /Ptrofs.max_unsigned; try done; lia.
Qed.
...
Proof.
  ...
  + iApply (nonlock_permission_bytes_valid_pointer with "H"); rewrite ?Ptrofs.unsigned_repr /Ptrofs.max_unsigned; try done; lia.
Qed.
...
Proof.
  ...
  + iApply (nonlock_permission_bytes_weak_valid_pointer with "H"); rewrite ?Ptrofs.unsigned_repr /Ptrofs.max_unsigned; try done; lia.
Qed.
