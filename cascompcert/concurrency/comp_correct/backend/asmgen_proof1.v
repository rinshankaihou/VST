...
(* mov *)
  econstructor. split. apply exec_straight_one. simpl. eauto. auto. auto.
...
(* modu *)
  ...
  simpl; intros. destruct H3. unfold rs1; Simplifs.
(* shrximm *)
  apply SAME. destruct Val.shrx in H1; inv H1. eapply mk_shrximm_correct; eauto.
(* lea *)
...
(* modlu *)
  ...
  simpl; intros. destruct H3. unfold rs1; Simplifs.
(* shrxlimm *)
  apply SAME. destruct Val.shrxl in H1; inv H1. eapply mk_shrxlimm_correct; eauto.
(* leal *)
...
(* intoffloat *)
  apply SAME. TranslOp. destruct Val.intoffloat in H1; inv H1; auto. rewrite H0; auto.
(* floatofint *)
  apply SAME. TranslOp. SimplifFPs; inv H1; auto. rewrite H0; auto.
(* intofsingle *)
  apply SAME. TranslOp. SimplifFPs; inv H1; auto. rewrite H0; auto.
(* singleofint *)
  apply SAME. TranslOp. SimplifFPs; inv H1; auto. rewrite H0; auto.
...
(* singleoflong *)
  apply SAME. TranslOp. SimplifFPs; inv H1; auto. rewrite H0; auto.
(* condition *)
  pose proof (transl_cond_correct cond args _ _ rs m EQ0); eauto.
