...
Proof.
  ...
  destruct eval_condition eqn:R; inv H.
  replace (Val.of_bool b) with (Val.of_optbool (Some b)) by auto.
  apply of_optbool_sound. rewrite <- R. eapply eval_static_condition_sound; eauto.
Qed.
