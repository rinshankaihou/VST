...
The RefinedCC project is adapted from [RefinedC](https://gitlab.mpi-sws.org/iris/refinedc/-/commits/ea6be6de7f27855a79c9ca18e6a54ba3bd5ed883).
...
Now we use the VST makefile to compile any RefinedCC Coq file:
...
```
 ...
 The script checks [./refinedVST/typing/frontend_stuff/examples/test_f_temps.c](./refinedVST/typing/frontend_stuff/examples/test_f_temps.c) and generates proofs in [./refinedVST/typing/frontend_stuff/examples/proofs/test_f_temps/](./refinedVST/typing/frontend_stuff/examples/proofs/test_f_temps/).
 In this folder, `generated_spec_vst.v` is the RefinedCC spec generated from annotations, `generated_code_vst_clight` is the Clight AST generated by CompCert frontend (clightgen), and `generated_proof_vst_f_temps.v` is the proof generated by our frontend modified from RefinedC. The script also verify correctness of the proof by compile the proof in Rocq.
